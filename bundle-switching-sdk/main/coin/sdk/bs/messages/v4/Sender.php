...
class Sender implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $networkoperator Code of the originator of the message.
     *
     * @return $this
     */
    public function setNetworkoperator($networkoperator)
    {
        ...
        if (!is_null($networkoperator) && (!preg_match("/^[0-9A-Z]{3,6}$/", $networkoperator))) {
            throw new InvalidArgumentException("invalid value for $networkoperator when calling Sender., must conform to the pattern /^[0-9A-Z]{3,6}$/.");
        }
     ...
     *
     * @param string $serviceprovider Code of the originator of the message.
     *
     * @return $this
     */
    public function setServiceprovider($serviceprovider)
    {
        ...
        if ((!preg_match("/^[0-9A-Z]{3,6}$/", $serviceprovider))) {
            throw new InvalidArgumentException("invalid value for $serviceprovider when calling Sender., must conform to the pattern /^[0-9A-Z]{3,6}$/.");
        }

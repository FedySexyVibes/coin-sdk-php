...
/**
 * RangeContent Class Doc Comment
 *
 * @category Class
 * @package  coin\sdk\np\messages\v3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RangeContent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'RangeContent';
...
'repeats' => '\coin\sdk\np\messages\v3\model\RangeRepeats[]'    ];
...
'repeats' => 'getRepeats'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['optanr'] = isset($data['optanr']) ? $data['optanr'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['optanr'] === null) {
            $invalidProperties[] = "'optanr' can't be null";
        }
     ...
     * @return string
     */
    public function getOptanr()
    {
        return $this->container['optanr'];
    }

    /**
     * Sets optanr
     *
     * @param string $optanr optanr
     *
     * @return $this
     */
    public function setOptanr($optanr)
    {
        $this->container['optanr'] = $optanr;
     ...
     * Sets repeats
     *
     * @param \coin\sdk\np\messages\v3\model\RangeRepeats[] $repeats repeats
     *
     * @return $this
     */

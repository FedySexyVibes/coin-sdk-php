...
/**
 * PortingPerformed Class Doc Comment
 *
 * @category Class
 * @package  coin\sdk\np\messages\v3
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PortingPerformed implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PortingPerformed';
...
'repeats' => 'getRepeats'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['batchporting'] = isset($data['batchporting']) ? $data['batchporting'] : null;
     ...
     * Sets actualdatetime
     *
     * @param string $actualdatetime actualdatetime
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getBatchporting()
    {
        return $this->container['batchporting'];
    }

    /**
     * Sets batchporting
     *
     * @param string $batchporting batchporting
     *
     * @return $this
     */
    public function setBatchporting($batchporting)
    {
        $this->container['batchporting'] = $batchporting;
     ...
     * Sets repeats
     *
     * @param \coin\sdk\np\messages\v3\model\PortingPerformedRepeats[] $repeats repeats
     *
     * @return $this
     */
